...
urlpatterns = [
    ...
    path('accessory-payment/<int:accessory_id>/', views.accessory_payment, name='accessory_payment'),
    path('payment/confirm/<int:payment_id>/', views.payment_confirm, name='payment_confirm'),
]